...
Use this guidance when reporting a DEAPack computation, implementation,
...
The repository does not invent author ORCIDs, affiliations, or a software
DOI. These fields are added only after the responsible person or issuing
